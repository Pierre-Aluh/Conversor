...
2. **Criar Primeiro Cadastro**
   ...
   - Preencha:
     ```
     Consórcio:
       Nome: Consórcio Exemplo 2026
       Código: consorcio_exemplo_2026
       Obra: obra_exemplo_01
     
     Consorciada:
       Nome: Empresa Exemplo Alpha - 40.00%
       Percentual: 40.00
       Código Empresa: 10
       Código Obra: 101
...
4. **Converter Arquivo**
   - Clique em "Procurar"
  - Selecione: `Consorcio Exemplo 01.26.xlsx`
...
2. **Selecionar Cadastro**
  ...
  - Selecione: "Empresa Exemplo Alpha - 40.00%"
   - ✅ Todos os campos preenchidos automaticamente!
...
Exemplo: Consorcio Exemplo 01.26 - Convertido.xlsx
```
